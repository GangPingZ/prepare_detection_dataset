...
category_item_id = -1        #z -1保证类别id从0开始
image_id = 20180000000       #z 不变
annotation_id = 0            #z 不变
    ...
    for _id in ids:
        ...
        for elem in root:
            ...
            for subelem in elem:
                ...
                #z 带坐标点顺序的xml文件，加上下面8行代码；不带的注释掉
                bndbox['x1'] = None
                bndbox['y1'] = None
                bndbox['x2'] = None
                bndbox['y2'] = None
...
if __name__ == '__main__':
    """ 通过txt文件生成 """
    #z xml文件夹路径
    voc_data_dir="I:/Datasate/ISDD"
    #z 生成的json文件路径
    json_save_path="I:/Datasate/ISDD/coco_format/isdd_val.json"
    #z 最后的位置参数是txt文件名
